...
class _MapTabScreenState extends State<MapTabScreen> {
  ...
  ''',
          ...
          if (incidents.mapEventsLoading) const Positioned(left: 0, right: 0, bottom: 0, child: LinearProgressIndicator(minHeight: 2)),
        ],
      ),
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton(heroTag: 'map_my_location', tooltip: 'My location', onPressed: _goToMyLocation, child: const Icon(Icons.my_location)),

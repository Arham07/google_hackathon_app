...
class IncidentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color borderColor = incident.isUserSubmitted ? AppColors.userSubmitted.withValues(alpha: 0.5) : AppColors.border;
    final Color bgColor = incident.isUserSubmitted ? AppColors.userSubmittedBg : AppColors.secondary.withValues(alpha: 0.5);
                        ...
                        children: [
                          ...
                          if (incident.isUserSubmitted)
                            Container(
                              ...
                              child: const Text(
                                'Citizen report',
                                style: TextStyle(color: AppColors.userSubmitted, fontSize: 10, fontWeight: FontWeight.w600),
                              ),
                            ),
                        ],
                      ),
  ...
  Widget _placeholderImage() {
    return Container(
      ...
      child: const Center(child: Icon(Icons.flood_outlined, size: 48, color: AppColors.mutedForeground)),
    );
  }
}
